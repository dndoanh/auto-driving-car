...
class Field:
    ...
    def _is_outside_field(self, car) -> bool:
    ...
    def _is_duplicated(self, car) -> bool:
    ...
    def add_car(self, car: Car) -> None:
        ...
        """
        if self._is_outside_field(car):
            raise ValueError(msg.MSG_CAR_OUTSIDE_FIELD)
        if self._is_duplicated(car):
            raise ValueError(msg.MSG_CAR_DUPLICATE)
